...
export default async function customerAuthRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/api/customer/auth/signup', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/api/customer/auth/verify', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
