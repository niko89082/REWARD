...
export default async function merchantAuthRoutes(fastify: FastifyInstance) {
  // Signup
  fastify.post('/api/merchant/auth/signup', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  // Login
  fastify.post('/api/merchant/auth/login', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
