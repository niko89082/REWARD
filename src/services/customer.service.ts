 ...
 * @returns Customer ID
 */
export async function findOrCreateByCard(
 ...
 */
export async function linkCardToCustomer(
  customerId: string,
  last4: string,
  zipCode: string
): Promise<string> {
 ...
 * @returns Customer ID
 */
export async function createCustomerWithPhone(phoneNumber: string): Promise<string> {
  try {
