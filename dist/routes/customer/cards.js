 ...
 */
export default async function customerCardsRoutes(fastify) {
    // Link card
    fastify.post('/api/customer/cards/link', { preHandler: [fastify.authenticateCustomer] }, async (request, reply) => {
        try {
    ...
    // List linked cards
    fastify.get('/api/customer/cards', { preHandler: [fastify.authenticateCustomer] }, async (request, reply) => {
        try {
            const customerId = request.customerId;
    ...
    fastify.get('/api/customer/balance/:merchantId', { preHandler: [fastify.authenticateCustomer] }, async (request, reply) => {
        try {
            const customerId = request.customerId;
