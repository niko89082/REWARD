 ...
 */
export async function verifyMerchantPassword(email, password) {
    try {
 ...
 */
export async function linkPOSIntegration(merchantId, provider, credentials) {
    try {
 ...
 */
export async function refreshAccessToken(integrationId) {
    try {
 ...
 */
export async function syncLocations(merchantId, posIntegrationId) {
    try {
        ...
        logger.info({ merchantId, posIntegrationId, count: locations.length }, 'Locations synced from POS');
    }
    catch (error) {
 ...
 */
export async function createReward(merchantId, rewardData) {
    try {
 ...
 */
export async function getMerchantRewards(merchantId, includeInactive = false) {
    try {
 ...
 */
export async function updateReward(rewardId, merchantId, rewardData) {
    try {
 ...
 * @param merchantId - Merchant ID (for authorization)
 */
export async function syncRewardToPOS(rewardId, merchantId) {
    try {
